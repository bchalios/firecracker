...
/// Start of memory region we will use for system data (MPTable, ACPI, etc). We are putting it
/// where EBDA normally is, i.e. in the last 1 KiB of the first 640KiB of memory, i.e in the range:
/// [0x9FC00, 0x9FFFF]
