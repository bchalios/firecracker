...
fn create_pci_nodes(fdt: &mut FdtWriter, pci_devices: &PciDevices) -> Result<(), FdtError> {
    ...
    let mem_32bit_devices_start = MEM_32BIT_DEVICES_START + 10 * 4096;
    let mem_32bit_devices_size = MEM_32BIT_DEVICES_SIZE - 10 * 4096;
    ...
    let ranges = [
        ...
        ((mem_32bit_devices_size & 0xffff_ffff) >> 32) as u32,
        // 64bit addresses
        0x300_0000u32,
        // PCI address
