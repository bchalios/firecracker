...
// valid guest memory.
fn iovec_try_from_descriptor_chain(mem: &GuestMemoryMmap, desc: &DescriptorChain) -> Result<iovec> {
...
mod tests {
    ...
    use crate::virtio::test_utils::test::{create_virtio_mem, VirtioTestTransport};
